...
CREATE TABLE db_1702.student (
  ...
  height DOUBLE(3, 2) COMMENT '身高',-- 身高
  price  DECIMAL(6, 2) COMMENT '价格',-- 价格    --  1234.56
  dob DATE COMMENT '出生日期',-- 年月日
  time DATETIME COMMENT '时间'-- 时间
);
...
-- TRUNCATE TABLE db_1702.student;-- 删除所有数据

-- DELETE FROM db_1702.student; -- 删除所有数据


SELECT *
FROM db_1702.student;   -- 查询结果
